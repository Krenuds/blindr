...
class VoiceBot:
    ...
    def __init__(self):
        ...
        self.bot = commands.Bot(command_prefix=os.getenv('BOT_PREFIX', '!'), intents=intents)
        ...
        self.whisper_client = WhisperClient(os.getenv('WHISPER_URL', 'http://localhost:9000'))
    ...
    def find_text_channel(self, guild):
        ...
        # Prefer 'transcriptions' channel if it exists
        for channel in guild.text_channels:
            if (channel.name.lower() == 'transcriptions' and 
    ...
    async def clear_messages(self, ctx):
        ...
        # Use Discord's purge method and let it handle efficiency
